	...
	if(isPickup_Inside_Zone == false){
		...
		var record = dmOMS.Online_Driver_Select(jData, function(data) {
				for (var i = 0; i < data.length; i++) {
					...
					if(!jData.fee_surcharge_code) max_driver_distance = global.RW_MAXDRVDISTANCE;
					if(jData.fee_surcharge_code) max_driver_distance = RW_MAXDRVDISTANCE_SURCHARGE_AREA;
