...
global.appConfig={
	db_order_management: {
		host: 'oms-vm-os.hkber.com.hk',
		port: 3306,
		database: 'db_order_management',
		user: 'root',
		password: '8BJ9hpfsDgHJ'
	},
	db_middle_slave_tier: {
		host: 'oms-vm-os.hkber.com.hk',
		port: 3306,
		database: 'db_middle_slave_tier',
		user: 'root',
		password: '8BJ9hpfsDgHJ'
	}
};
...
global.api_server_domain = 'middle-hk-core-os.hkber.com.hk';
global.middle_slave_api_server_domain = 'middle-hk-core-os.hkber.com.hk';
...
global.RW_RMDT = 300	 			//Request match driver timeout Unit: second 
global.RW_DGPICKLT = 120*60*60 		//Driver goto pickup location timeout Unit: second
global.RW_DGDROPLT = 6*60*60		//Driver goto drop location timeout Unit: second
global.RW_DGDROP_GPS_LOST_TO = 20*60	//Driver goto drop location GPS lost tolerance Unit: second
global.RW_DACKOT = 25 				//Driver acknowlege order timeout Unit: second
global.RW_MAXDRVDISTANCE = 4      	//Max driver distance to pickup location Unit: KM
