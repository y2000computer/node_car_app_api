...
global.appConfig={
	db_order_management: {
		host: 'localhost',
		port: 3306,
		database: 'db_order_management_dev',
		user: 'root',
		password: 'password'
	},
	db_middle_slave_tier: {
		host: 'localhost',
		port: 3306,
		database: 'db_middle_slave_tier_dev',
		user: 'root',
		password: 'password'
	}
};
...
global.api_server_domain = 'localhost';
global.middle_slave_api_server_domain  = 'localhost';
...
global.RW_RMDT = 120	 			//Request match driver timeout Unit: second (Different to PROD)
global.RW_DGPICKLT = 3*60*60 		//Driver goto pickup location timeout Unit: second  (Different to PROD)
...
global.RW_DACKOT = 30 				//Driver acknowlege order timeout Unit: second (Different to PROD)
global.RW_MAXDRVDISTANCE = 3      	//Max driver distance to pickup location Unit: KM
global.RW_MAXDRVDISTANCE_SURCHARGE_AREA = 20      	//Max driver distance to pickup location (Surcharge Area) Unit: KM
...
global.image_root_folder =  'C:/wamp/www/hkber_oms/document/';
