...
function OMS_Standard_Model(){
	...
	this.Standard_Fee_Peak_Hour_Master_List = function(callback){

	if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Standard_Fee_Peak_Hour_Master_List');

	var statement ='select sf.peak_code, sf.grade_code, sf.region_code, sf.desc_eng, sf.desc_chn,sf.desc_time_eng, \
