...
function OMS_Cust_Request_WorkFlow_Model(){
	...
	this.Driver_Online_Handshaking_Update = function(driver_user_id, callback){

	//if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Driver_Online_Handshaking_Update');

	var statement ='update tbl_rosf_driver_online_gps set ';
		statement	+= ' handshaking_datetime = NOW() ' + ' ';
		statement	+= ' where ';
		statement	+= ' driver_user_id = ' + '"' + driver_user_id + '"';
	...
	};	//this.Driver_Online_Handshaking_Update = function(request_id, callback){
	...
	this.Match_Driver_Push_Message_Insert = function(jData, callback) {

	//if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Match_Driver_Push_Message_Insert');
	
	var statement ='insert into tbl_msg_driver_push_message (request_id, driver_user_id, message,  create_datetime)  ';
			statement	+= ' values (';
			statement	+= '"' + jData.request_id+ '"' +  ',';
			statement	+= '"' + jData.driver_user_id+ '"' +  ',';
			statement	+= '"' + jData.message+ '"' +  ',';
			statement	+= ' NOW()  ';
			statement	+= ' ); ';
	...
	//add 7 Oct, 2017
	this.Driver_Acknowledge_Timeout_Update = function(jData, callback){

	//if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Driver_Acknowledge_Timeout_Update');

	var statement ='update tbl_rosf_order_request_match_driver set ';
		statement	+= ' driver_order_confirm_timeout_datetime =  now()  ';
		statement	+= ' where ';
		statement	+= ' request_id = ' + jData.request_id 
		statement	+= ' and ';
		statement	+= ' driver_user_id = ' + jData.driver_user_id 
	...
	//add  8 Oct, 2017
	this.Request_Matched_Driver_History_Select = function(request_id, callback){

	//if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Request_Matched_Driver_History_Select');

	var statement ='SELECT * FROM tbl_rosf_order_request_match_driver ';
	...
	//add  21 Nov 2017
	this.Close_And_Driver_Not_Available_Request_Update = function(request_id, callback){
	...
	//add  24 Nov 2017
	this.Request_Nearly_Driver_Update = function(jData, callback){

	//if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Request_Nearly_Driver_Update');

	var statement ='update tbl_rosf_order_request_flow s set ';
		statement	+= ' nearly_driver_create_datetime = ' + '"' +jData.create_datetime + '"' +  ',';
		statement	+= ' nearly_driver_user_id = ' + jData.driver_user_id +  ',';
		statement	+= ' nearly_driver_registration_id = ' + jData.registration_id +  ',';
		statement	+= ' nearly_driver_lat = ' + jData.lat +  ',';
		statement	+= ' nearly_driver_lng = ' + jData.lng +  ',';
		statement	+= ' nearly_driver_history = ' + '"'+ jData.nearly_driver_history+ '"' +  ',';
		statement	+= ' nearly_driver_matching_timer = ' + '"' +jData.matching_timer + '"' +  ' ';
		statement	+= ' where ';
		statement	+= ' request_id = ' + jData.request_id 
	...
	};	//this.Request_Nearly_Driver_Update = function(request_id, callback){
	...
	//add  27 Nov 2017
	this.Request_Last_GPS_Select = function(request_id, callback){

	if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Request_Last_GPS_Select');
		
	var statement ='select * from tbl_rosf_order_request_driver_gps rg ';
		statement	+= ' where ';
		statement	+= ' request_id = ' + request_id ;
	...
	this.Driver_Arrive_Drop_GPS_Lost_Update = function(request_id, last_gps_server_log_datetime, callback){

	//if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Driver_Arrive_Drop_GPS_Lost_Update');

	var statement ='update tbl_rosf_order_request_flow s set ';
		statement	+= ' state_code = "ERR_GOTO_DROP_LOST_GPS"' + ',';
		statement	+= ' wf_closed_driver_drop_lost_gps_datetime = "' + last_gps_server_log_datetime + '"' + ' , ';
		statement	+= ' wf_driver_arrive_drop_datetime = "' + last_gps_server_log_datetime + '"' + ' , ';
		statement	+= ' wf_closed_route_complete_datetime = "' + last_gps_server_log_datetime + '"' + '  ';
		statement	+= ' where ';
		statement	+= ' request_id = ' + request_id 
	...
	};	//this.Driver_Arrive_Drop_GPS_Lost_Update = function(request_id, callback){	
