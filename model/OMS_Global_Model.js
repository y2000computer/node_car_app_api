...
function OMS_Global_Model(){
	...
	this.Global_Response_Code_Master_List_All = function(callback){

	if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Global_Response_Code_Master_List_All');
	...
	this.Global_Language_Master_List_All = function(callback){

	if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Global_Language_Master_List_All');
	...
	this.Global_Mobile_Country_Master_List_All = function(callback){

	if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Global_Mobile_Country_Master_List_All');
	...
	this.Global_Public_Holiday_List_All = function(callback){

	if(global.debug) console.log ('__filename: '+__filename+' & func: '+'Global_Public_Holiday_List_All');
	
	var statement= 'select holiday_id, country_code, holiday_name_eng, \
